...
if __name__ == "__main__":
    ...
    smod.DoStochSim(trajectories=1, mode='time', end=10000, method="TauLeaping", IsTrackPropensities=True)
    # smod.DoCainStochSim(endtime=20000, frames=10000, trajectories=1, solver="HomogeneousDirect2DSearch", IsTrackPropensities=False)
    smod.GetRegularGrid()
